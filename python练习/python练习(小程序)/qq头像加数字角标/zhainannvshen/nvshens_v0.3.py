...
class Capture:
    def __init__(self):
        ...
        self.index_page_url = 'http://www.nvshens.net/'
        # 搜索页面
        self.search_page_url = 'https://www.nvshens.net/gallery/:key/'
        # 作品内容主页
        self.one_page_url = 'https://www.nvshens.net/g/:key/'
        # root folder
    ...
    def readPageByThread(self, item_size, path, img_mod_url, file_hz):
        ...
        for item in range(1, item_size - 1):
            ...
            t = MyThread(self.write_img,
                         (new_page_url, new_path, self.sleep_time),
                         self.write_img.__name__)
            threads.append(t)
